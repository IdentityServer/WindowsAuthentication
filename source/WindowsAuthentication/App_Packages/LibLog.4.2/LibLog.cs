...
namespace IdentityServer.WindowsAuthentication.LibLog
#else
namespace IdentityServer.WindowsAuthentication.Logging
#endif
{
    using System.Collections.Generic;
#if LIBLOG_PROVIDERS_ONLY
    using IdentityServer.WindowsAuthentication.LibLog.LogProviders;
#else
    using IdentityServer.WindowsAuthentication.Logging.LogProviders;
#endif
    using System;
#if !LIBLOG_PROVIDERS_ONLY
    ...
    static class LogProvider
    {
        ...
        /// will be disabled.
        /// </summary>
        public const string DisableLoggingEnvironmentVariable = "IdentityServer.WindowsAuthentication_LIBLOG_DISABLE";
...
#if LIBLOG_PROVIDERS_ONLY
namespace IdentityServer.WindowsAuthentication.LibLog.LogProviders
#else
namespace IdentityServer.WindowsAuthentication.Logging.LogProviders
#endif
{
    using System;
    using System.Collections.Generic;
